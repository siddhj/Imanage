...
public class LoginVerification {
	...
	public LoginVerification(String jarversion, String firmname, String gstin, String filestoreaddress,
			...
			LocalDate logdate, int licenseid, String logemailaddress, String logemailpassword, String licensekey) {
		super();
		this.jarversion = jarversion;
		this.firmname = firmname;
		this.gstin = gstin;
	...
	public String toString() {
		return "LoginVerification [jarversion=" + jarversion + ", firmname=" + firmname + ", gstin=" + gstin
				+ ", filestoreaddress=" + filestoreaddress + ", logstoreaddress=" + logstoreaddress
				+ ", logemailaddress=" + logemailaddress + ", logemailpassword=" + logemailpassword + ", licensekey="
				+ licensekey + ", newchallanaccess=" + newchallanaccess + ", sortandfilteraccess=" + sortandfilteraccess
				+ ", newassigneeaccess=" + newassigneeaccess + ", logdate=" + logdate + ", licenseid=" + licenseid
				+ "]";
	}
