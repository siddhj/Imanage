...
import other.ChallanInsertThread;
import utility.UTable;

public class DataManipulation {
	public void getPopUpWindowData(ObservableList<Chalan> mainpagechallanlist) throws SQLException, IOException, DocumentException, InterruptedException {
