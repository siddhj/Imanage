...
//					int numberofpaid = Integer.parseInt(textField.getText());
//					commitEdit(Integer.parseInt(textField.getText()));
//					
//					TableView<Chalan> tableview = UTable.getPopuptableview();
//					ObservableList<Chalan> receivetablelist = tableview.getItems();
//					
//					ObservableList<Chalan> updatereceivetablelist = MicroService.updatePopUpTableView(receivetablelist,numberofpaid);
